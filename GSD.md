...
-   Review Security Assessments to validate what potentially needs
    remediation: <https://learn.microsoft.com/en-us/defender-for-identity/security-assessment#assessment-reports>

-   Full list of the 44 Alerts that are being checked on your behalf
    when fully deployed: <https://learn.microsoft.com/en-us/defender-for-identity/alerts-overview>
...
------------------------------------------------------------- -------------------------------------------------------------
  ![](./images/media/image4.png)   ![](./images/media/image5.png)
...
-   Microsoft Purview eDiscovery: <https://aka.ms/ediscoveryninja>
 ![thumbnail image 2 of blog post titled Become a Microsoft Purview eDiscovery Ninja](./images/media/image12.png)
...
+=====================================+================================+
| ![](./images/media/image            | ![](./images/media/image14.png  |
| 13.png) | g) |
|                                     |                                |
|                                     |                                |
|                                     |                                |
